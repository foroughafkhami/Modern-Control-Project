%% Four Tank System_Phase 1_Simulation
clc;
clear;
close all;
%% Parameters 
...
h1_d = -a(1)/A(1)*sqrt(2*g*h1)+a(3)/A(1)*sqrt(2*g*h3)+y(1)*k(1)/A(1)*v1+0.0037;
h2_d = -a(2)/A(2)*sqrt(2*g*h2)+a(4)/A(2)*sqrt(2*g*h4)+y(2)*k(2)/A(2)*v2+0.0037;
